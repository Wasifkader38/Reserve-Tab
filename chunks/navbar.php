<section class="fnavbar">
		...
		<nav>
		    <div class="nav-wrapper">
		      <a href="#" class="brand-logo">ReserveTab</a>
		      <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
		      <ul class="right hide-on-med-and-down">
		        <li><a href="/ReserveTab" class="hvr-grow">Home</a></li>
		        <li><a href="/ReserveTab/about-reservetab.php" class="hvr-grow">About Us</a></li>
		        <li><a href="food-categories.php" class="hvr-grow">Categories</a></li>
		        <li><a href="foods.php" class="hvr-grow">Foods</a></li>
                <li><a href="Reservation.php" class="hvr-grow">Reserve Table</a></li>
		        <li><a href="#" class="hvr-grow" onclick="toggleModal('Contact Info', 'You can contact us directly by calling to this number +88 01797261281. Check the bottom Footer Section of the website for more info.');">Contact</a></li>
		  ...
		  <ul class="sidenav" id="mobile-demo">
		    <li><a href="/ReserveTab">Home</a></li>
	        <li><a href="/ReserveTab/about-reservetab.php">About Us</a></li>
	        <li><a href="food-categories.php">Categories</a></li>
	        <li><a href="foods.php">Foods</a></li>
	        <li><a href="foods.php" >Reserve Table</a></li>
